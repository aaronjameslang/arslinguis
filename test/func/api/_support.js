...
var FIXTURE_DEFAULTS = {
    ...
    description: function() {
      return 'should correctly respond to ' + this.request.path;
    },
};
...
function testFixture(fixture) {
    fixture = deepmerge(FIXTURE_DEFAULTS, fixture);
    var description = (fixture.description instanceof Function) ? fixture.description() : fixture.description;
